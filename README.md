## StarSectorLocalizer-Machine-MODS (Машинный перевод Модов)
#На текущий момент (08.04.2023) переводчик не умеет обрабатывать символ комментариев #, по этому если будете испльзовать словари отсюда, то в исходных файлах (те которые будете переводить) нужно удалить все комментарии. Это не касается jar.
